...
CREATE TABLE `Difficulty` (`difficultyId` int(11) NOT NULL AUTO_INCREMENT, `difficulty` varchar(255) DEFAULT NULL, PRIMARY KEY (`difficultyId`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
